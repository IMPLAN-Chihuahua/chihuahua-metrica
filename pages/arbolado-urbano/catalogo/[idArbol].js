          ...
          <List>
            <Grid container  >
              ...
              <Grid xs={12} sm={6}>
                <ListItem>
                  <Box margin={5}
                    ...
                    component="img" src={'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQGDvNn5NeqLxJtVBwrt2Ps3ny1IUvklfPtg9TkknXx&s'}></Box>
              ...
              <Grid xs={6}>
                ...
                <Grid xs={6}>
                  <ListItem>
                    <Box><ListItemText primary="Autor(es) de Imágenes" /></Box>

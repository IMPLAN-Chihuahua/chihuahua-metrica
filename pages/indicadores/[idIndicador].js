        ...
        <Grid container xs={12} md={12}>
          <Grid xs={12} md={6} sx={{ bgcolor: "" }}>
            ...
            <Grid container spacing={3} sx={{ mt: "1%" }}>
              <Information
                ...
                body="Año al que se refiere el último valor disponible"
              />
              <Information
                header={data.CoberturaGeografica}
                title="Cobertura geográfica"
                body="Territorio al que se refiere la captación de datos"
              />
            </Grid>
          </Grid>
          ...
          >
            ...
            >
              ...
              <h2>Formula</h2>
              <MathJax.Provider>
                <h1 className="formulaText">
                  <MathJax.Node inline formula={formulaTest} />
                </h1>
              </MathJax.Provider>
              <h3>Descripción</h3>
              <p>

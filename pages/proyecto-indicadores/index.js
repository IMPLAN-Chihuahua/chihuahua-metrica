...
export default function Modulo(props) {
    ...
    return (
        <>
            <Container>
                <Head>
                    <title>Modulos de Chihuahua</title>
                    <meta name="description" content="Generated by create next app" />
                    <link rel="icon" href="/favicon.ico" />
                </Head>

                <Title variant={'h1'} margin={'3% 0 1% 0'}>Módulos de Chihuahua</Title>
                ...
                <br />
                <Title variant={'h4'} fontWeight={'bold'} margin={'0 0 2% 0'}>Temas de interés</Title>
